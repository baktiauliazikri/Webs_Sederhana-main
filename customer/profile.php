...
<body>
	...
	<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="nama_customer" id="nama" placeholder="Nama" required="required" value="<?php echo $cust['nama_customer']; ?>">
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label for="telepon">Telepon</label>
						<input type="number" class="form-control" name="telp" id="telepon" placeholder="Nomor Telepon" required="required" value="<?php echo $cust['telp']; ?>">
					</div>
				</div>
			</div>
			<div class="row">
		...
		<hr>
		<h3 class="display-5">Riwayat Transaksi</h3>
