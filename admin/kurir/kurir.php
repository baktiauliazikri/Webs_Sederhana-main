...
<body class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="kurir.php"><i class="app-menu__icon fa fa-list-alt"></i><span class="app-menu__label">Kategori</span></a></li>
      ...
      <li><a class="app-menu__item active" href="../product/product.php"><i class="app-menu__icon fa fa-truck"></i><span class="app-menu__label">Kurir</span></a></li>
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h3><i class="fa fa-truck"></i> Kurir</h3>
        <p>Data Kurir Jahe Emprit Mama Gio.</p>
      </div>
  ...
  <script src="ajax_kurir.js"></script>
    ...
    <div class="modal-content">
      <form role="form" id="form-tambah" method="post" action="aksi_query.php">
        <div class="modal-header">
          <h4 class="modal-title">Menambahkan kurir</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label>Nama Kurir</label>
            <input class="form-control" id="kurir" name="nama" required="required" placeholder="Nama Kurir">
          </div>
          <div class="form-group">
            <label>Biaya Kurir</label>
            <input type="number" class="form-control" id="kurir" name="biaya" required="required" placeholder="Biaya Kurir">
          </div>
          <div class="form-group">
            <label>Waktu Pengiriman</label>
            <input class="form-control" id="kurir" name="waktu" required="required" placeholder="Waktu Pengiriman">
          </div>
        </div>
...
<div id="modal-edit" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form role="form" id="form-edit" method="post" action="update_kurir.php">
        <div class="modal-header">
...
<div id="modal-hapus" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Delete kurir</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <div id="delete-kurir"></div>
      </div>
      </form>
    </div>
  </div>
