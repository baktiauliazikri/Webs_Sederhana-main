...
<body class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="rekening.php"><i class="app-menu__icon fa fa-credit-card"></i><span class="app-menu__label">No Rekening</span></a></li>
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h3><i class="fa fa-credit-card"></i> Rekening</h3>
        <p>Data Rekening Jahe Emprit Mama Gio.</p>
      </div>
  ...
  <script src="ajax_rekening.js"></script>
    ...
    <div class="modal-content">
      <form role="form" id="form-tambah" method="post" action="aksi_query.php">
        <div class="modal-header">
          <h4 class="modal-title">Menambahkan rekening</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label>Nama Bank</label>
            <input class="form-control" id="nama" name="nama" required="required" placeholder="Nama Bank">
          </div>
          <div class="form-group">
            <label>No.Rekening</label>
            <input class="form-control" id="no_rek" name="no_rek" required="required" placeholder="No Rekening">
          </div>
          <div class="form-group">
            <label>Atas Nama</label>
            <input class="form-control" id="atas_nama" name="atas_nama" required="required" placeholder="Atas Nama">
          </div>
          <div class="form-group">
            <label>Logo Bank</label>
            <input type="file" class="form-control" id="logo_bank" name="gambar" required="required">
          </div>
        </div>
...
<div id="modal-hapus" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Delete rekening</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <div id="delete-rekening"></div>
      </div>
      </form>
    </div>
  </div>
